...
<head>
  ...
  <title><?php echo SIS_ABREV; ?> | <?php echo SIS_NAME; ?> - Recuperação de Senha</title>
  <style type="text/css">
      ...
      <tr class="header-background">
        <td class="header container" align="center">
          <div class="content">
            <span class="brand">
              <a href="#">
                <?php echo SIS_ABREV; ?> | <?php echo SIS_NAME; ?>
              </a>
            </span>
          </div>
        </td>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Obrigado!</p>
                              <p class="body-signature"><?php echo SIS_NAME; ?></p>
                            </td>
                          </tr>
                        </table>
                      </td>
      ...
      <tr>
        ...
        <td class="container">
          <div class="content footer-lead">
            <a href="#"><b>Entre em contato</b></a> caso tenha alguma dúvida ou sugestão
          </div>
        </td>
        <td></td>
      </tr>
